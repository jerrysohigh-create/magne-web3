...
- **Developers** — Developer Hub with network configuration and guides
  - Connect Wallet — How to connect to MAGNE testnets
  - Deploy Contract — Hardhat and Foundry deployment guides
  - Build DApp — DApp development tutorials
...
- **Transparency Center** — Legal documents, audits, and disclosures
- **FAQ** — Frequently asked questions

## Documentation Pages

- [Developer Hub](https://web3.magne.ai/developers.html)
- [Connect to Testnets](https://web3.magne.ai/developers-connect.html)
- [Deploy Smart Contracts](https://web3.magne.ai/developers-contract.html)
- [Build a DApp](https://web3.magne.ai/developers-app.html)
- [Version History](https://web3.magne.ai/version-history.html)
...
The MAGNE L1 and M Hash L2 networks are currently in testing phase.

- **MAGNE L1 Testnet Chain ID:** 20250810
- **M Hash L2 Testnet Chain ID:** 20250827
- **Token:** MHA
